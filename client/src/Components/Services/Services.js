  ...
  return (
    <section className="offer-container" id="nasze-uslugi" ref={services}>
      ...
      <div className="icons-container">
        ...
        <Service src={icon7}>
          Doradztwo techniczne związane z sieciami teletechnicznymi
        </Service>
        <Service src={icon8}>
          Nadzory inwestorskie nad realizacją zadań teletechnicznych
        </Service>
        <Service src={icon9}>
          Oferujemy obsługę formalnoprawną oraz projekty do wymienionych zadań
        </Service>
      </div>
    </section>
  );
